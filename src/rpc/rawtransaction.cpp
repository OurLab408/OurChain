...
UniValue getrawtransaction(const JSONRPCRequest& request)
{
    ...
    // [contract update]: get CTransaction from CTransactionRef
    Contract contract = tx->contract;
    result.push_back(Pair("contractAction", contract.action));
    result.push_back(Pair("contractAddress", contract.address.GetHex()));
