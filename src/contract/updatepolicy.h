...
{
public:
    virtual UpdatePolicyType getType() const
    {
        return UpdatePolicyType::UpdatePolicy_DoNothing;
    };
    virtual bool UpdateSnapShot(ContractStateCache *cache,
        SnapShot &snapshot,
        CChain &chainActive,
...
UpdatePolicy *SelectUpdatePolicy(CChain &chainActive,
...
{
public:
    UpdatePolicyType getType() const override
    {
        return UpdatePolicyType::UpdatePolicy_Rebuild;
    }
    bool UpdateSnapShot(ContractStateCache *cache,
        SnapShot &snapshot,
        CChain &chainActive,
        const Consensus::Params consensusParams) override;
};
...
public:
    UpdatePolicyType getType() const override
    {
        return UpdatePolicyType::UpdatePolicy_Forward;
    }
    bool UpdateSnapShot(ContractStateCache *cache,
        SnapShot &snapshot,
        CChain &chainActive,
...
public:
    UpdatePolicyType getType() const override
    {
        return UpdatePolicyType::UpdatePolicy_Rollback;
    }
    bool UpdateSnapShot(ContractStateCache *cache,
        SnapShot &snapshot,
        CChain &chainActive,
